...
// если определено, то шрифт кладется в EEPROM
//#define FONT_IN_EEPROM 
//--------------------------
...
/*
 * Таблица для отображения символов (ASCII[0x00-0x1F] + ASCII[0x20-0x7F] + CP1251[0xC0-0xFF])
 */
static const unsigned char TOMEM FontLookup [][5] =
{
   { 0x7F, 0x41, 0x41, 0x41, 0x7F },	// 0x00		0
   { 0x3E, 0x5B, 0x4F, 0x5B, 0x3E },	// 0x01		1  sad
   { 0x3E, 0x6B, 0x4F, 0x6B, 0x3E },	// 0x02		2  happy
   { 0x18, 0x3C, 0x78, 0x3C, 0x18 },	// 0x03		3  heart
   { 0x18, 0x3C, 0x7E, 0x3C, 0x18 },	// 0x04		4  diamond
   { 0x1C, 0x57, 0x7D, 0x57, 0x1C },	// 0x05		5  clover
   { 0x1C, 0x5E, 0x7F, 0x5E, 0x1C },	// 0x06		6  spade
   { 0x00, 0x7E, 0x43, 0x43, 0x7E },	// 0x07		7  bat low
   { 0x00, 0x7E, 0x73, 0x73, 0x7E },	// 0x08		8  bat med
   { 0x00, 0x7E, 0x7F, 0x7F, 0x7E },	// 0x09		9  bat high
   { 0x7F, 0x41, 0x41, 0x41, 0x7F },	// 0x0A		10  line feed
   { 0x30, 0x48, 0x3A, 0x06, 0x0E },	// 0x0B		11  male
   { 0x06, 0x29, 0x79, 0x29, 0x06 },	// 0x0C		12  female
   { 0x7F, 0x41, 0x41, 0x41, 0x7F },	// 0x0D		13  carriage return
   { 0x60, 0x70, 0x3F, 0x02, 0x04 },	// 0x0E		14  note
   { 0x2A, 0x1C, 0x36, 0x1C, 0x2A },	// 0x0F		15  sun
   { 0x7F, 0x3E, 0x1C, 0x08, 0x00 },	// 0x10		16  right triangle
   { 0x00, 0x08, 0x1C, 0x3E, 0x7F },	// 0x11		17  left triangle
   { 0x14, 0x22, 0x7F, 0x22, 0x14 },	// 0x12		18  double arrow
   { 0x3C, 0x3C, 0x3C, 0x7E, 0xFF },	// 0x13		19  speaker
   { 0x18, 0x42, 0x3C, 0x81, 0x7E },	// 0x14		20  sound
   { 0x3E, 0x63, 0x75, 0x63, 0x3E },	// 0x15		21  A button
   { 0x3E, 0x61, 0x6B, 0x63, 0x3E },	// 0x16		22  B button
   { 0x3E, 0x63, 0x6B, 0x6B, 0x3E },	// 0x17		23  C button
   { 0x04, 0x02, 0x7F, 0x02, 0x04 },	// 0x18		24  up arrow
   { 0x10, 0x20, 0x7F, 0x20, 0x10 },	// 0x19		25  down arrow
   { 0x08, 0x08, 0x2A, 0x1C, 0x08 },	// 0x1A		26  right arrow
   { 0x08, 0x1C, 0x2A, 0x08, 0x08 },	// 0x1B		27  left arrow
   { 0x14, 0x3E, 0x55, 0x41, 0x22 },	// 0x1C		28  euro
   { 0x63, 0x75, 0x69, 0x75, 0x63 },	// 0x1D		29  timer
   { 0x10, 0x18, 0x1C, 0x18, 0x10 },	// 0x1E		30  up triangle
   { 0x04, 0x0C, 0x1C, 0x0C, 0x04 },	// 0x1F		31  down triangle
